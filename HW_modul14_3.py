...
async def get_buying_list(message):
    ...
    texts = [
        'Набор из 20ти пар уютных теплых носки с разными принтами! Цена 100$',
        'Самые мягкие и удобные футболки с сказочными принтами! Цена 200$',
        'Модные джинсы из лучшей ткани! Цена 300$',
        'Теплая удобная и стильная куртка для прохладной осени! Цена 400$'
    ]
